...
namespace Bazaar_Of_The_Bizarre.Bank.BankFlyweight {
	class Bank : IBank {
		...
		/// </param>
		/// <returns>
		///     Bool Returns true if account was created
		/// </returns>
		...
		/// </param>
		/// <returns>
		///     Bool returns true if transaction was made
		/// </returns>
		public bool Transaction(double sum, int customerId) {
			if(_accounts.ContainsKey(customerId)) {
				var customerAccount = _accounts[customerId];
		...
		/// </param>
		/// <returns>
		///     Double Returns current fund of the bankaccount
		/// </returns>
		...
		/// </summary>
		/// <returns>
		///     Dictionary of int,BankAccount Returns dictionary with bankaccounts.
		/// </returns>
